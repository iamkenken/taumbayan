   ...
   <body>
      ...
      <table width="100%" bgcolor="#eee" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header" >
         <tbody>
            <tr>
               <td>
                  <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" style="border-bottom: 4px solid #ddd;">
                     <tbody >
                        <tr>
                           <td width="100%">
                              <table bgcolor="#0e0e0e" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                                 <tbody >
                                    <!-- Spacing -->
                                    <tr>
                                    ...
                                    <tr>
                                       <td>
                                          ...
                                          <!-- end of logo -->
                                          <!-- start of Logo Name -->
                                          <table width="200" border="0" align="left" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                                             <tbody>
                                                <tr>
                                                   <td align="left"  st-content="phone"  height="50">
                                                      <a href="http://taumbayan.com" style="font-family: Oswald Regular, Helvetica, arial, sans-serif; font-size: 18px;color: #ffffff; text-decoration:none;"> Taumbayan </a>
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                          <!-- end of Logo Name -->
                                          <!-- start of menu -->
                                          <table width="200" border="0" align="right" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                                             <tbody>
                                                <tr>
                           ...
                           <td width="100%">
                              <table bgcolor="#ffffff" width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                                 <tbody>
                                    ...
                                    <!-- bottom-border -->
                                    <tr>
                                       <td width="100%" bgcolor="#0e0e0e" height="3" style="font-size: 1px; line-height: 1px;">&nbsp;</td>
                                    </tr>
                                    <!-- /bottom-border -->
                                 </tbody>
                              </table>
