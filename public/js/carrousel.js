...
(function ($) {
    ...
    $.carrousel.prototype = {
        ...
        _showButton: function () {
			...
			var x = _self.indexB;
			if(x==0){
				$( "#cat-name" ).text( "Current Events" );

			}else if(x==1){
				$( "#cat-name" ).text( "Education" );
			}else if(x==2){
				$( "#cat-name" ).text( "Entertainment" );
			}else if(x==3){
				$( "#cat-name" ).text( "Health" );
			}else if(x==4){
				$( "#cat-name" ).text( "Politics" );
			}else if(x==5){
				$( "#cat-name" ).text( "Sports" );
			}else{
				$( "#cat-name" ).text( " " );
			}
        ...
        _layout: function () {
            ...
            this.$currentItm.removeClass('overlay');    
        ...
        _loadEvents: function () {
            ...
            this.$wrapper.on('webkitTransitionEnd.carrousel transitionend.carrousel OTransitionEnd.carrousel', function () {
                _self.$currentItm.removeClass('overlay');
